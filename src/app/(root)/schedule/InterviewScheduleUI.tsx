...
//   // Only interviewers (no candidates anymore)
//   const interviewers = users?.filter((u) => u.role === "interviewer");

//   // Form Data without candidateId
//   const [formData, setFormData] = useState({
//     title: "",
//     description: "",
//     date: new Date(),
...
//     try {
//       const { title, description, date, time, interviewerIds } = formData;
//       const [hours, minutes] = time.split(":");
//       const meetingDate = new Date(date);
//       meetingDate.setHours(parseInt(hours), parseInt(minutes), 0);
...
//         status: "upcoming",
//         streamCallId: id,
//         interviewerIds: [user.id], // Everyone is interviewer
//       });
...
function InterviewScheduleUI() {
  ...
  // Disabled function (no backend call)
  const scheduleMeeting = () => {
    setOpen(false); // bas dialog band hoga
  };
